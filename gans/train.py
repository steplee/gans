...
def main():
    ...
    parser.add_argument('--restoreOpt', action='store_true') # Note: This make chkpt file LARGE
    ...
    #parser.add_argument('--penaltyFreq', default=1,type=int)
    ...
    parser.add_argument('--addNoiseToD', default=False,type=makeBool)
    parser.add_argument('--loss', default='lsganTwo')
    parser.add_argument('--name', default='unnamedGan')
    parser.add_argument('--useMinibatchStd', default=True,type=makeBool)
    ...
    parser.add_argument('--dFakeEval', default=False,type=makeBool)
    parser.add_argument('--useSpectralNorm', default=False,type=makeBool)
    ...
    for epoch in range(5000):
        for _ in range(9999999):
            ...
            model.net_g.train()
            model.net_d.train()
            if model.dFakeEval: model.net_d.eval()
